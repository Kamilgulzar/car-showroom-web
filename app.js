...
// main.innerHTML = carlist.Suzuki.Mehran.Model;
...
for(var key in carlist){
  ...
  for(var key1 in carlist[key]){
    ...
    main.innerHTML += `
    <div class="col-12 col-sm-12 col-md-6 col-lg-3 mb-4 pr-6">
  <div class="card" style="width: 18rem;">
    <img src="${obj.image || "https://www.suzukipremier.com/wp-content/uploads/2020/10/Suzuki_Mehran_2012.jpg"}" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">${key1.toUpperCase()} (${obj.model})</h5>
      <p class="card-text">${obj.seatcapacity} </br> ${obj.Transmission} </br> ${obj.Mileage}</p>
      <h6>${obj.price}</h6>
  ...
  function searchCar(){
    ...
    carDetail.innerHTML = ` <div class="card mb-3" style="max-width: 540px;">
    <div class="row g-0">
      <div class="col-md-4">
